 ...
 * Typically you will instead want to use [PostBodyText],
...
private class ReadMoreState(
    ...
    var collapsedText: AnnotatedString
        ...
        internal set(value) {
            if (value != _collapsedText) {
                ...
                if (DebugLog) {
                    Logger.d("collapsedText changed: $_collapsedText")
                }
            }
        }
    ...
    private fun updateCollapsedText() {
        ...
        if (textLayout != null &&
            ...
            if (DebugLog) {
                Logger.d("updateCollapsedText: collapsedText=$collapsedText")
            }
        }
    }
